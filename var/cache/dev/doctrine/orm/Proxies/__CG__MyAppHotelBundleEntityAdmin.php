 ...
 */
class Admin extends \MyApp\HotelBundle\Entity\Admin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MyApp\\HotelBundle\\Entity\\Admin' . "\0" . 'idAdmin', '' . "\0" . 'MyApp\\HotelBundle\\Entity\\Admin' . "\0" . 'login', '' . "\0" . 'MyApp\\HotelBundle\\Entity\\Admin' . "\0" . 'pwd'];
        }
